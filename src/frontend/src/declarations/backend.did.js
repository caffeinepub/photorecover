...
export const idlService = IDL.Service({
  ...
  'emptyTrash' : IDL.Func([], [], []),
  'getActivePhotos' : IDL.Func([], [IDL.Vec(PhotoMetadata)], ['query']),
  'getCallerUserProfile' : IDL.Func([], [IDL.Opt(UserProfile)], ['query']),
  'getCallerUserRole' : IDL.Func([], [UserRole], ['query']),
  'getTrashedPhotos' : IDL.Func([], [IDL.Vec(PhotoMetadata)], ['query']),
  ...
  'permanentlyDeletePhoto' : IDL.Func([IDL.Text], [], []),
  'recoverPhoto' : IDL.Func([IDL.Text], [], []),
  'saveCallerUserProfile' : IDL.Func([UserProfile], [], []),
  'softDeletePhoto' : IDL.Func([IDL.Text], [], []),
